...
namespace ECGViewer.Formularios
{
    public partial class FrmImpresion : Form
    {
        ...
        private bool _autoEscalaY;

        public FrmImpresion(Chart chart, in List<Muestra> senal, string unidad, bool autoEscalaY)
        {
            chartSenal = chart;
            _senal = senal;
            _autoEscalaY = autoEscalaY;
            InitializeComponent();
        }
        ...
        private void PrintDocument_Triple_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            GraphicHelpers.CargarGrafico(chartSenal, _senal, _autoEscalaY );
        }
